...
class DataProvider {
    ...
    data(r, c) {
        ...
        if (tpl) {
            return tpl(index.h, this.dataProvider.rowDataModel(r, c));
        }
...
const RevoGrid = class {
    ...
    async componentDidLoad() {
        if (!('ResizeObserver' in window)) {
            ...
            const module = await new Promise(function (resolve) { resolve(require('./resize-observer-aeccf0a6.js')); });
    ...
    render() {
        return index.h("revogr-viewport-scrollable", { class: 'viewport', ref: (el) => { this.viewport = el; } }, index.h("revogr-header", { slot: 'header', class: 'header' }), index.h("revogr-data", { slot: 'content', class: 'viewport-layer' }));
    }
    ...
    render() {
        ...
        for (let row of rowsStore$1.get('items')) {
            ...
            for (let col of colsStore$1.get('items')) {
                cells.push(index.h("div", { class: 'data-cell', style: { width: `${col.size}px`, transform: `translateX(${col.start}px)` } }, dataStore.provider.data(row.itemIndex, col.itemIndex)));
            }
            rowsEls.push(index.h("div", { class: 'row', style: { height: `${row.size}px`, transform: `translateY(${row.start}px)` } }, cells));
        }
        return rowsEls;
    }
    get element() { return index.getElement(this); }
...
const ViewportDataComponent = class {
    ...
    render() {
        const cells = [];
        for (let col of colsStore$1.get('items')) {
            cells.push(index.h("div", { class: 'data-header-cell', "data-col": col.itemIndex, style: { width: `${col.size}px`, transform: `translateX(${col.start}px)` } }, dataStore.provider.header(col.itemIndex)));
        }
        return cells;
    }
    get element() { return index.getElement(this); }
...
const RevogrViewportScrollable = class {
    ...
    render() {
        return [
            index.h("div", { class: 'vertical-scroll', ref: (el) => { this.verticalVirtScroll = el; }, onScroll: () => this.scrollVirtY() }, index.h("div", { style: { height: `${rowsStore.get('realSize')}px` } })),
            index.h("div", { class: 'horizontal-wrapper', ref: (el) => { this.horizontalScroll = el; }, onScroll: () => this.scrollX() }, index.h("div", { class: 'inner-content-table' }, index.h("div", { class: 'header-wrapper', ref: (el) => { this.header = el; } }, index.h("slot", { name: 'header' })), index.h("div", { class: 'vertical-wrapper' }, index.h("div", { class: 'vertical-inner', ref: (el) => { this.verticalScroll = el; }, onScroll: () => this.scrollY() }, index.h("div", { style: { height: `${rowsStore.get('realSize')}px`, width: `${colsStore.get('realSize')}px` } }, index.h("slot", { name: 'content' }))))))
        ];
    }
};

exports.revo_grid = RevoGrid;
exports.revogr_data = RevogrData;
exports.revogr_header = ViewportDataComponent;
exports.revogr_viewport_scrollable = RevogrViewportScrollable;
